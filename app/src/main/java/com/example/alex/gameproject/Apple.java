...
public class Apple extends Fruit {
    ...
    public Apple(Context context, int screenX, int screenY, float scaleFactor) {
        super(context, screenX, screenY, scaleFactor);

        originBitmapNormal = BitmapFactory.decodeResource(context.getResources(), R.drawable.apple);
        ...
        originBitmapFrozen = BitmapFactory.decodeResource(context.getResources(), R.drawable.fapple);
